...
contract SmartContractWallet {
    ...
    function addGuardians(address _guardian, bool _isGuardian) public {
         require(msg.sender == owner, "You are not a Owner");
         guardians[_guardian] = _isGuardian;
    ...
    function transfer(address payable _to, uint _amount, bytes memory _payload) public returns(bytes memory) {
        ...
        if(msg.sender != owner) {
            require(isAllowedToSend[msg.sender], "You are trying to send money to a non allowed address, aborting..");
